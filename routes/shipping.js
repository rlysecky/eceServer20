...
router.get("/rates", function(req, res) {
   ...
   // 1-day, 2-day, 3-day, and 4+ day shipping
    ...
    // TODO 1: If the service property is not defined in the query string,
    ...
    let shippingCosts = { costs: {} };

    // TODO 2: If carrier is specified, return costs just for that carrier. 
    ...
    if( req.query.hasOwnProperty("carrier") && req.query.carrier != "") {
       ...
       for(let carrier in shippingRates) {
          shippingCosts.costs[carrier] = shippingRates[carrier][req.query.service]; 
       }
    }
